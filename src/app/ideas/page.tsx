    ...
    <>
      ...
      <section className="logic-section section-shell">
        ...
        <div className="logic-flow" aria-label="社会変革の循環">
          <div><span>01</span><b>働く人の声</b><p>経験がクチコミとして集まる</p></div>
          <div><span>02</span><b>情報の透明化</b><p>職場の実態を比較できる</p></div>
          <div><span>03</span><b>主体的な選択</b><p>個人と企業が互いに選ぶ</p></div>
          <div><span>04</span><b>誠実な経営</b><p>選ばれる組織へ変わり続ける</p></div>
        </div>
      </section>
